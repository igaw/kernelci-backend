...
BUILD_LOGS_DIR = "logs"
BUILD_ERRORS_FILE = os.path.join(BUILD_LOGS_DIR, "build-errors.log")
BUILD_WARNINGS_FILE = os.path.join(BUILD_LOGS_DIR, "build-warnings.log")
BUILD_MISMATCHES_FILE = os.path.join(BUILD_LOGS_DIR, "build-mismatches.log")
